...
Estre trabalho realizou um estudo de caso sobre a integridade do elemento de barreira de poço revestimento durante cenários de perfuração. Estes fazem parte do CSB secundário e são vitais para o controle de $blowouts$ conforme prevê o SGIP. Os cenários avaliados foram perda de circulação total e $kick$ de gás. O revestimento condutor, considerando o primeiro cenário, atendeu as envoltórias de von Mises e API. Por outro lado, nessa mesma operação o revestimento de superfície sofreu plastificação e não atendeu aos coeficientes de segurança. Analogamente, o revestimento intermediário sob um cenário de $kick$ também ficou fora do domínio seguro. 

Assim, foram avaliados diferentes graus para os tubos dos revestimentos de superfície e intermediário, considerando projetos mais conservadores, ou seja, que não aceitam a plastificação na coluna e a violação dos fatores de segurança. Deste modo, indicou-se tubos com grau C90 e C95, respectivamente. Buscando economia e segurança, ainda sugeriu-se a utilização de seções compostas em ambos os revestimentos. Destacam-se ainda as funcionalidades do CWELL fornecendo análises triaxiais, resistências e esforços, os quais são úteis para dimensionamento de colunas de revestimento, bem como verificação da integridade. 
