...
\begin{center}
\center
\subfigure[ref1][]{\includegraphics[width=10cm]{./Figures/CSB_corrigido.png}}\qquad
\subfigure[ref2][]{\includegraphics[width=5.2cm]{./Figures/poco2.pdf}}
\caption{\centering{Elementos de barreira de poço em um processo de perfuração. a) Fonte: Adaptado de \citep{norge2013norsok}; b) Fonte: Adaptado de \citep{inbook}.}}
\label{fig:resultsF1}
\end{center}
\end{figure}
