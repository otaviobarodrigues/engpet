...
A Tabela \ref{Eq1} apresenta as resistências à tração, ao colapso e ao $burst$ nos revestimentos do poço. 
...
Na Figura \ref{fig:resultsF1}(a) é apresentada a análise triaxial do revestimento condutor. A envoltória dos esforços de circulação total encontra-se no interior dos limites API e da elipse de von Mises, apontando que não há falha por ELU e ELS.
